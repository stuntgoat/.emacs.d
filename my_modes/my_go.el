...
(fset 'ig-golang-for-range
   (lambda (&optional arg) "Keyboard macro." (interactive "p") (kmacro-exec-ring-item (quote ([102 111 114 32 24 81 return 44 32 24 81 return 32 58 61 32 114 97 110 103 101 32 24 81 return 123 2 32 6 13] 0 "%d")) arg)))
